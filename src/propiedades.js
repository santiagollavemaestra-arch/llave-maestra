...
window.importarDesdePortal = async () => {
  ...
  try {
    ...
    const skipW=['logo','icon','placeholder','avatar','sprite','banner','map','profile','user','marca','watermark','favicon','loading','qr','naventcdn','arrow','chevron','next-','prev-','slider','carousel'];
